...
/////Métodos para patrones de validación de formatos de los siguientes campos/////
fun Activity.isValidEmail(email: String):Boolean{
    //Patron validación email
    val pattern = Patterns.EMAIL_ADDRESS
    return pattern.matcher(email).matches()

}
fun Activity.isValidPassword(password: String):Boolean{
    //Patron validación password Necesita contener: Min 1 núm/1 Minúscula/ 1 Mayús/Min 8 caracteres
